...
<td>Rp {{ number_format($order->nominal, 0, ',', '.') }}</td>
    <td>{{ $order->cf->title }}</td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal-lg" data-id="{{ $order->id }}" data-nama="{{ $order->nama }}" data-no-telepon="{{ $order->no_telpon }}" data-email="{{ $order->email }}" data-nominal="{{ $order->nominal }}" data-pesan="{{ $order->pesan }}">
